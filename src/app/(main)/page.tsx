...
import { PlayCircle, Home, Video, FileText, Users, ArrowLeft } from "lucide-react";
...
export default async function HomePage(): Promise<JSX.Element>{
  ...
  return (
    <>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r py-20 text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h3 className="text-4xl font-extrabold mb-6">به دنبال ملک دلخواهت هستی؟</h3>
          ...
          <Link
            href="/listings"
            className="inline-flex items-center gap-3 bg-[#FEC360] text-gray-900 px-10 py-4 rounded-2xl font-bold text-lg hover:bg-[#fed27a] transition shadow-2xl hover:shadow-3xl"
          >
            مشاهده املاک
